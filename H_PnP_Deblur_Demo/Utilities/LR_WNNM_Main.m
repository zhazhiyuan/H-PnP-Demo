...
function [Imout] = LR_WNNM_Main(InputImage, Opts)
...
Similar_patch          =                 Opts.Similar_patch;
...
for  i             =             1 : NN
    ...
    lambda              =                    2*sqrt(2)*Opts.c*Opts.sigma^2./(cc + Opts.e);
        
    %tau                 =                    lambda/lr_lambda;
    
    tau                  =                   lambda*step*Similar_patch/Opts.lambda;
