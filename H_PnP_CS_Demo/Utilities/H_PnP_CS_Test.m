...
function [filename,ratio,PSN_Result,FSIM_Result,SSIM_Result, jjj, diffff, Time_s]   =   H_PnP_CS_Test(filename, ratio, mu, lambda, c, thr, Err_or)
    ...
    % fprintf('Initial PSNR = %0.2f\n',csnr(par.org,par.initial,0,0));
     ...
     fprintf('..................................................\n');
        ...
        [reconstructed_image, PSN_Result,FSIM_Result,SSIM_Result,diffff, jjj] = H_PnP_CS_Main(y,par, Err_or);
        ...
        Final_Name= strcat(filename,'_H_PnP_CS_',num2str(ratio),'_PSNR_',num2str(PSN_Result),'_FSIM_',num2str(FSIM_Result),'_SSIM_',num2str(SSIM_Result),'.png');
